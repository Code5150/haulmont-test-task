INSERT INTO Patient (Patient_ID, Surname, Name, Patronymic, PhoneNumber) VALUES (0, 'Жмышенко', 'Валерий', 'Альбертович', '228-14-88');
...
INSERT INTO Doctor (Doctor_ID, Surname, Name, Patronymic, Specialization) VALUES (0, 'Кузнецов', 'Петр', 'Иванович', 'Аллерголог');
INSERT INTO Doctor (Doctor_ID, Surname, Name, Patronymic, Specialization) VALUES (1, 'Воронин', 'Максим', 'Глебович', 'Флеболог');
INSERT INTO Doctor (Doctor_ID, Surname, Name, Patronymic, Specialization) VALUES (2, 'Сергеев', 'Владимир', 'Станиславович', 'Терапевт');
INSERT INTO Doctor (Doctor_ID, Surname, Name, Patronymic, Specialization) VALUES (3, 'Тоцкий', 'Валерий', 'Анатольевич', 'Отоларинголог');
INSERT INTO Doctor (Doctor_ID, Surname, Name, Patronymic, Specialization) VALUES (4, 'Семёнов', 'Степан', 'Александрович', 'Венеролог');
INSERT INTO Doctor (Doctor_ID, Surname, Name, Patronymic, Specialization) VALUES (5, 'Валерьев', 'Валерьян', 'Валерьевич', 'Терапевт');
